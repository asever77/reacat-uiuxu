...
import { Label } from "@/components/uiux/label";
...
function FormItem({
  ...
  const hasDescription = React.Children.toArray(props.children).some(
    (child) =>
      React.isValidElement(child) &&
      (child.type as React.FC).displayName === FormDescription.displayName
  );
